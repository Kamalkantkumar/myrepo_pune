...
<%@page import="com.te.car_managment.Dto.CarInfo"%>

<%@ include file="navbar.jsp"%>

<%
	CarInfo info = (CarInfo) request.getAttribute("found");
%>
...
body {
	font-family: Arial;
	background-image: url("https://www.imagesjunction.com/images/img/black_background_png.jpg");
...
<body>
	...
	<form class="example" action="./searchadmin" method="post"
