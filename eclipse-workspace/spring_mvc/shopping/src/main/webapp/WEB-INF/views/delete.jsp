...
<h1 style="text-align:center; ">Delete Car Details</h1>
<%if(s!=null && !s.isEmpty()){ %>
<h2 style="color:red;text-align:center;padding-left:520px  "><%=s%></h2>
  <%} %>
<form action="./delete" method="post">
<div class="wrapper fadeInDown">
  <div id="formContent">
    <!-- Tabs Titles -->
    <h2 class="active"> DELETE</h2>
    ...
    <!-- Login Form -->
    <form>
      <input type="text" id="login" class="fadeIn second" name="id" placeholder="Car Id" required="required">
